...
function Listbookinglocation() {
  ...
  for (let i = 0; i < 100; i++) {
    data.push({
      ...
      status: ['Completed', 'Canceled', 'Checking'],
...
const [inputText, setInputText] = useState("");
  ...
  return (
    <div className='list container-md'> 
     <div className='link'><Link to='/admin'>Dashboard</Link><Link> / Location Booking List</Link></div>
      <h3 className='mb-4'>Location Booking List</h3>
      <Table
      bordered
    columns={columns}
    dataSource={data}
...
export default Listbookinglocation